...
class optionsChain:
    def __init__(self, underlyingSymbol='AAPL', strikeFrom=100, strikeTo=100, side='call'):
        ...
        self.url = f'https://api.marketdata.app/v1/options/chain/{underlyingSymbol}/?strike={strikeFrom}-{strikeTo}&from={self.dateFrom}&to={self.dateTo}&side={self.side}'
